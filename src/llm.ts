...
export class Llm {
  private readonly options: Required<LlmOptions>;
  ...
  async process(input: unknown): Promise<Record<string, unknown>> {
    ...
    return { status: "success", module: "Llm", result };
  }
  ...
  getStatus(): Record<string, unknown> {
    return { module: "Llm", initialized: this.initialized, dataKeys: [...this.data.keys()] };
  }
