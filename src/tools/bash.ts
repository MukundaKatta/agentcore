...
export class Bash {
  private readonly options: Required<BashOptions>;
  ...
  async process(input: unknown): Promise<Record<string, unknown>> {
    ...
    return { status: "success", module: "Bash", result };
  }
  ...
  getStatus(): Record<string, unknown> {
    return { module: "Bash", initialized: this.initialized, dataKeys: [...this.data.keys()] };
  }
